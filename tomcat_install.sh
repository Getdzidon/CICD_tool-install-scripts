...
#Variables
TOMCAT_BASE_VERSION="tomcat-9" # most stable version
TOMCAT_VERSION="9.0.98"          # Set the version you want to install ref for the latest version: https://archive.apache.org/dist/tomcat/tomcat-9/ in case this version does not work
